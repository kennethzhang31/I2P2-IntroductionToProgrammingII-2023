...
void SettingScene::Initialize() {
    ...
    // Setting
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW +350 , halfH +250, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingScene::PlayOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW +550, halfH + 300, 0, 0, 0, 255, 0.5, 0.5));
    //slider
